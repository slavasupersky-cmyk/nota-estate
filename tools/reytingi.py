...
def shkoly(root):
 ...
 <div class="ri-body" hidden>{body}</div>
    ...
    body = cover('img/ix-2026-09-shkola.jpg', 'Кампус современной школы',
                 f'<b>Рейтинг</b><span>Школы Москвы</span><span>Август 2026</span><span>{n_all} школ</span>',
...
<section class="method" id="arhitektura"><div class="wrap">
 <div class="two">
  <div><p class="ttl">Отдельный разбор</p><h2 style="margin-top:20px">Школа как<br>архитектура</h2><a href="{R}razbory/shkola-kak-arhitektura/" style="display:block;margin-top:28px"><div class="ph has" data-ar="16x9"><img src="{R}img/22-shkola-maket.jpg" alt="Макет школьного кампуса: корпуса вокруг двора, спортзал, стадион и амфитеатр" loading="lazy"></div></a></div>
