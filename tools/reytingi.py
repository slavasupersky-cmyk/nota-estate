...
<section id="metodika"><div class="wrap">
 ...
 <div class="tablewrap"><table class="ri-w">
  <tr><th>Источник</th><th>Что считаем</th><th>Баллы</th></tr>
{chr(10).join(f'  <tr><td><b>{e(a)}</b></td><td>{e(b)}</td><td>{c}</td></tr>' for a, b, c in WEIGHTS)}
 </table></div>
